...
namespace Application.MVC.Services
{
    public interface INotificationService
    {
        Task CreateNotificationAsync(int userId, string title, string message, Notification.NotificationType type, string actionUrl = null, int? relatedEntityId = null);
    ...
    public class NotificationService : INotificationService
    {
        ...
        public async Task CreateNotificationAsync(int userId, string title, string message, Notification.NotificationType type, string actionUrl = null, int? relatedEntityId = null)
        {
            try
            {
                ...
                Crud<Notification>.Create(notification);
            }
            catch (Exception ex)
            {
        ...
        public async Task NotifyFollowersAsync(int artistId, string musicTitle, int musicId)
        {
            try
            {
                ...
                var artist = Crud<Music>.GetAll().FirstOrDefault(m => m.ArtistId == artistId)?.Artist;
                ...
                foreach (var follow in follows)
                {
                    await CreateNotificationAsync(
                        ...
                        Notification.NotificationType.NewMusic,
        ...
        public async Task NotifySubscriptionExpiringAsync(int userId, string planName, DateTime expiryDate)
        {
            ...
            await CreateNotificationAsync(
                ...
                Notification.NotificationType.SubscriptionExpiry,
